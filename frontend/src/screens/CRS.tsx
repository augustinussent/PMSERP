    ...
    <div className="space-y-5">
              ...
              <CardContent className="p-4">
                <div className="mb-3 flex flex-wrap items-baseline justify-between gap-2">
                  ...
                  <span className="text-xs text-zinc-500">
                    {p.available_rooms} rooms · from Rp {idr(p.from_rate)}/night
                  </span>
                </div>
                    ...
                    <div key={rt.room_type} className="flex flex-wrap items-center gap-3 py-2.5">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-xs text-zinc-500">
                          {rt.available} left · sleeps {rt.adults_capacity} · Rp {idr(rt.per_night)}/night
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="text-sm font-semibold">Rp {idr(rt.total)}</div>
      ...
      {booking && (
        <Sheet
          ...
          description={`${booking.property_name} · ${checkIn} → ${checkOut} · Rp ${idr(booking.rt.total)} total`}
        ...
        >
          <div className="space-y-3">
            ...
            <label className="block">
              ...
              <input className={inputCls} value={guest.phone} placeholder="+62 …"
