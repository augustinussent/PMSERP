...
export const roomTypesConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "base_price", label: "Base Rp /night" },
    { field: "base_occupancy", label: "Base occ." },
    { field: "extra_adult_price", label: "Extra adult Rp " },
    { field: "tax_percent", label: "PB1 & Service %" },
  ],
  form: [
    ...
    { field: "tax_percent", label: "PB1 & Service %", type: "float" },
...
export const vouchersConfig: ScreenConfig = {
  ...
  form: [
    ...
    { field: "value", label: "Value (10 = 10% or Rp 10)", type: "float", required: true },
...
export const mealPlansConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "price_per_adult", label: "Rp  / adult / night" },
    { field: "price_per_child", label: "Rp  / child / night" },
    { field: "is_default", label: "Default" },
  ],
  form: [
...
export const venuesConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "base_price", label: "Indicative Rp " },
  ],
  form: [
...
export const venueBookingsConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "quoted_amount", label: "Quoted Rp " },
  ],
  form: [
...
export const shiftsConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "status", label: "Status", badge: true },
    { field: "closing_cash", label: "Closing cash Rp " },
  ],
  form: [
...
export const guardrailsConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "floor_price", label: "Floor Rp " },
    { field: "ceiling_price", label: "Ceiling Rp " },
  ],
  form: [
...
export const companiesConfig: ScreenConfig = {
  ...
  form: [
    ...
    { field: "gstin", label: "PB1IN", type: "data" },
    { field: "contact_name", label: "Contact name", type: "data" },
    { field: "contact_phone", label: "Contact phone", type: "data" },
    { field: "contact_email", label: "Contact email", type: "data" },
...
export const billingConfig: ScreenConfig = {
  ...
  title: "Billing",
  description:
    "Reservation totals. Folios, charge posting and PB1 invoices arrive in the next milestone.",
  propertyScoped: true,
  allowCreate: false,
  allowDelete: false,
  ...
  columns: [
    ...
    { field: "amount_before_tax", label: "Pre-tax Rp " },
    { field: "discount_amount", label: "Discount Rp " },
    { field: "tax_amount", label: "PB1 Rp " },
    { field: "amount_after_tax", label: "Total Rp " },
  ],
  form: [
    { field: "guest_name", label: "Guest", type: "readonly" },
    { field: "amount_before_tax", label: "Pre-tax", type: "readonly" },
    { field: "tax_amount", label: "PB1", type: "readonly" },
...
export const reservationsConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "amount_after_tax", label: "Total Rp " },
    { field: "advance_paid", label: "Advance Rp " },
  ],
...
export const outletsConfig: ScreenConfig = {
  ...
  columns: [
    ...
    { field: "gst_rate", label: "PB1 & Service %" },
  ],
  form: [
    ...
    { field: "gst_rate", label: "PB1 & Service %", type: "float" },
    { field: "disabled", label: "Disabled", type: "check" },
  ],
}
