      ...
      {counting && (
        <Sheet
          ...
          footer={
            ...
            >
              Collect {countPieces} piece{countPieces === 1 ? "" : "s"} · Rp 
              {idr(countTotal)}
            </Button>
          }
        >
            ...
            <tbody>
              {rates.map((r) => (
                <tr key={r.name} className="border-t border-zinc-100">
                  ...
                  <td className="text-right tabular-nums">Rp {idr(r.rate)}</td>
                  <td className="text-right tabular-nums text-zinc-500">
                    Rp {idr(r.express_rate)}
                  </td>
                  {canEdit && (
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              <Stat label="Revenue" value={`Rp ${idr(rev.revenue)}`} />
