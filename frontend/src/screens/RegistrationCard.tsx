      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-6 print:border-0">
        <div className="mb-5 flex items-start justify-between border-b border-zinc-300 pb-4">
          <div>
            ...
            <p className="text-xs text-zinc-500">
              {d.property.gstin && <>PB1IN {d.property.gstin} · </>}
              {d.property.phone}
            </p>
          </div>
        ...
        <div className="grid gap-x-8 sm:grid-cols-2">
          ...
          <div>
            ...
            <Row label="Stay total" value={`Rp ${idr(d.reservation.rate_total)} (incl. PB1)`} />
            <Row label="Advance paid" value={`Rp ${idr(d.reservation.advance_paid)}`} />
