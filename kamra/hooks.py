...
# Add ERPNext Sync Hooks
doc_events.setdefault("Guest", {}).setdefault("on_update", []).append("kamra.integration.erpnext_sync.sync_guest")
doc_events.setdefault("Folio", {}).setdefault("on_submit", []).append("kamra.integration.erpnext_sync.sync_folio")
doc_events.setdefault("POS Order", {}).setdefault("on_submit", []).append("kamra.integration.erpnext_sync.sync_pos_order")
doc_events.setdefault("Folio Payment", {}).setdefault("on_submit", []).append("kamra.integration.erpnext_sync.sync_payment")
doc_events.setdefault("Sales Invoice", {}).setdefault("on_submit", []).append("kamra.integration.erpnext_sync.intercept_ury_invoice")
